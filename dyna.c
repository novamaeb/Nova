...
#include <jansson.h>
#include <string.h>
//gcc -o dyna.o dyna.c -lsqlite3 -ljansson 
...
int main() {
    ...
    while ((rc = sqlite3_step(stmt)) == SQLITE_ROW) {
            ...
            json_object_set_new(object, "age", json_integer(sqlite3_column_int(stmt, 2)));
            json_object_set_new(object, "contact_number", json_integer(sqlite3_column_int(stmt, 3)));
            json_object_set_new(object, "email", json_integer(sqlite3_column_int(stmt, 4)));
